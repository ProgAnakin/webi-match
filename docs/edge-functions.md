...
```json
{ "ok": true, "code": "SUP-A1B2C3D410", "emailId": "brevo-message-id" }
```

Discount code format: `SUP-` + 4 random hex bytes + 2-digit discount percentage. Example: `SUP-A1B2C3D410` = 10% discount.
