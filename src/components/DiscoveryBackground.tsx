...
const DiscoveryBackground = memo(() => (
  ...
  >
    ...
    <div style={{ position:"absolute", left:"-8%", top:"-5%", width:"max(480px,35vw)", height:"max(480px,35vw)", borderRadius:"50%", background:"radial-gradient(circle,hsla(217, 91%,55%,0.85) 0%,transparent 70%)", filter:"blur(max(60px,5vw))", opacity:0.20, animation:"wb-orb-a 9s ease-in-out infinite", willChange:"transform" }} />
    <div style={{ position:"absolute", right:"-10%", top:"0", width:"max(420px,30vw)", height:"max(420px,30vw)", borderRadius:"50%", background:"radial-gradient(circle,hsla(188, 86%,50%,0.85) 0%,transparent 70%)", filter:"blur(max(70px,5.5vw))", opacity:0.16, animation:"wb-orb-b 11s ease-in-out infinite", willChange:"transform" }} />
    <div style={{ position:"absolute", right:"-6%", bottom:"4%", width:"max(360px,28vw)", height:"max(360px,28vw)", borderRadius:"50%", background:"radial-gradient(circle,hsla(217, 91%,62%,0.85) 0%,transparent 70%)", filter:"blur(max(65px,5vw))", opacity:0.13, animation:"wb-orb-c 10s ease-in-out infinite", willChange:"transform" }} />
    ...
    {/* ── Slow scanline ─────────────────────────────────────────── */}
    <div style={{ position:"absolute", left:0, right:0, top:0, height:2, background:"linear-gradient(90deg,transparent,hsla(217, 91%,55%,0.5),transparent)", opacity:0.09, animation:"wb-scanline 12s linear infinite", willChange:"transform" }} />
  </div>
));
